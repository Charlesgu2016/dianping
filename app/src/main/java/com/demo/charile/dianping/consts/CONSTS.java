package com.demo.charile.dianping.consts;

public class CONSTS {
	
	
//	public static final String HOST = "http://192.168.2.107:8080/dzdp"; //home
	public static final String HOST = "http://192.168.1.106:8080/dzdp"; //office
